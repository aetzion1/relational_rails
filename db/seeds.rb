...
p_violin = Instrument.create!(name: 'Principal', date_hired: '2006-04-20', section_id: clarinet.id)
vp_violin = Instrument.create!(name: 'Vice Principal', date_hired: '2020-02-17', section_id: clarinet.id)